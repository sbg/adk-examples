Example automation that processes multi-lane FASTq files into de-duplicated BAMs with built-in QC checkpoints. Input for this automation is a sample manifest in tab-separated format that specifies sample IDs with corresponding FASTq filenames.
